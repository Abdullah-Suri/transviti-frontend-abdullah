        ...
        <div className='flex items-center justify-between lg:flex-nowrap flex-wrap bg-white p-5 rounded-[10px] mt-5'>
            ...
            <div className='w-fit flex items-center flex-wrap lg:mt-0 mt-2.5 max-md:gap-5'>
                <div className='relative text-teriatory lg:border-x sm:border-r' onClick={() => setIsOpen(!isOpen)}>
                    ...
                    {isOpen && (
                        <ul className="absolute left-0 mt-2 w-full bg-white border rounded-md shadow-md z-10">
                            <li className='py-2.5 lg:px-7 px-4 cursor-pointer hover:bg-[#F7F7F7]'>Karachi</li>
                            <li className='py-2.5 lg:px-7 px-4 cursor-pointer hover:bg-[#F7F7F7]'>Lahore</li>
                            <li className='py-2.5 lg:px-7 px-4 cursor-pointer hover:bg-[#F7F7F7]'>Islamabad</li>
                        </ul>
                    )}
                </div>
                <div className='relative text-teriatory' onClick={() => setIsOpenLocation(!isOpenLocation)}>
                    ...
                    {isOpenLocation && (
                        <ul className="absolute left-0 mt-2 w-full bg-white border rounded-md shadow-md z-10">
                            <li className='py-2.5 lg:px-7 px-4 cursor-pointer hover:bg-[#F7F7F7]'>Remote</li>
                            <li className='py-2.5 lg:px-7 px-4 cursor-pointer hover:bg-[#F7F7F7]'>On-site</li>
                            <li className='py-2.5 lg:px-7 px-4 cursor-pointer hover:bg-[#F7F7F7]'>Hybrid</li>
                        </ul>
                    )}
                </div>
