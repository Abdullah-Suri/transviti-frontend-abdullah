  ...
  return (
    <div className='w-full rounded-[10px] bg-white border border-white'>
      <div className='relative'>
        ...
        <img src={userProfileImg} className='xl:size-[110px] md:size-[80px] sm:size-[120px] size-[90px] absolute top-1/2 left-1/2 -translate-x-1/2' alt="user profile img" />
      </div>
      <div className='xl:pt-16 pt-12 pb-5 text-center xl:px-10 px-5'>
        ...
        <p className='text-teriatory'>Clinton, Maryland</p>
      </div>
    </div>
  )
}
